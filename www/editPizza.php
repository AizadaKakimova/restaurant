...
session_start();	 
    ...
    while($row = $result->fetch_row()) {
      $pizzasList[$i]['id'] = $row[0];
      $pizzasList[$i]['name'] = $row[1];
      $pizzasList[$i]['price'] = $row[2];
      $pizzasList[$i]['description'] = $row[3];
      $i++;
    }
?>
<!DOCTYPE html> 
...
<section class="admin-product">
  <div class="container">
    ...
    <a href="addItemP.php" class="admin-add"><i class="fa fa-plus"></i>ADD</a>
    ...
    <table class="">
      ...
      <?php foreach($pizzasList as $pizza): ?>
        <tr>
          ...
          <td>
            <a href="updateP.php" class="edit"><i class="fa fa-pencil-square-o"></i></a>    
          </td>
          <td>
          <a href="deleteItem.php?deleteItem=<?php echo $pizza['id']; ?>"><i class="fa fa-times"></i></a>          </td>
        </tr>
      <?php endforeach; ?>
      </tbody>
    </table>
