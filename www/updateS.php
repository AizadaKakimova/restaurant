...
<table>
  ...
  <form method="POST" action="updateItemS.php">
    <td><textarea name="saladList[]" readonly><?php echo $salad['id'];?></textarea></td>
    <td><input placeholder="<?php echo $salad['name']; ?>" name="saladList[]"></td>
    <td><input placeholder="<?php echo $salad['price']; ?>" name="saladList[]"></td>
    <td><textarea placeholder="<?php echo $salad['description']; ?>" name="saladList[]"></textarea></td>
    <td><a href="updateItemS.php"><i class="fa fa-save"></i></a></td>
    </form>
  </tr>
  <? 
  endforeach;
