...
<table>
  ...
  $steakList=array();
    ...
    while($row = $result->fetch_assoc()) {
      $steakList[$i]['id']=$row['id'];
      $steakList[$i]['name']=$row['name'];
      $steakList[$i]['price']=$row['price'];
      $steakList[$i]['description']=$row['description'];
      $i++;
    }
  foreach ($steakList as $steak) :
  ?>
  <tr>
  <form method="POST" action="updateItemSt.php">
    <td><textarea class="numbers" name="steakList[]" readonly><?php echo $pizza['id'];?></textarea></td>
    <td><input class="books-edit" placeholder="<?php echo $steak['name']; ?>" name="steakList[]"></td>
    <td><input class="books-edit" placeholder="<?php echo $steak['price']; ?>" name="steakList[]"></td>
    <td><textarea class="books-edit" placeholder="<?php echo $steak['description']; ?>" name="steakList[]"></textarea></td>
<td><a href="updateItemSt.php"><i class="fa fa-save"></i></a></td>    </form>
  </tr>
  <? 
  endforeach;
}
