...
session_start();	 
    ...
    while($row = $result->fetch_row()) {
      $saladsList[$i]['id'] = $row[0];
      $saladsList[$i]['name'] = $row[1];
      $saladsList[$i]['price'] = $row[2];
      $saladsList[$i]['description'] = $row[3];
      $i++;
    }
?>
<!DOCTYPE html> 
...
<section class="admin-product">
  <div class="container">
    ...
    <a href="addItemS.php" class="admin-add"><i class="fa fa-plus"></i>ADD</a>
    ...
    <table class="">
      ...
      <tbody>
      <?php foreach($saladsList as $salad): ?>
        <tr>
          <td><?php echo $salad['id']; ?></td>
          <td><?php echo $salad['name']; ?></td>
          <td><?php echo $salad['price']; ?></td>
          <td><?php echo $salad['description']; ?></td>
          <td>
            <a href="updateS.php"><i class="fa fa-pencil-square-o"></i></a>
          </td>
          <td>
            <a href="deleteItemS.php?deleteItemS=<?php echo $salad['id']; ?>"><i class="fa fa-times"></i></a> </a>
          </td>
        </tr>
      <?php endforeach; ?>
      </tbody>
